...
export const PASSWORD_CREATE = "createPassword";
export const PASSWORD_DESTROY = "destroyPassword";
export const PASSWORD_APPROVE = "approvePassword";
export const PASSWORD_UNAPPROVE = "unapprovePassword";
export const PASSWORD_DISAPPROVE = "disapprovePassword";
export const PASSWORD_UNDISAPPROVE = "undisapprovePassword";
